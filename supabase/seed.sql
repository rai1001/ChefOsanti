...
insert into public.stock_movements (id, org_id, batch_id, delta_qty, reason, note, created_by)
values
  ('71200000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '71000000-0000-0000-0000-000000000001', 5, 'purchase', 'Entrada demo', null),
  ('71200000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', '71000000-0000-0000-0000-000000000002', 8, 'purchase', 'Entrada demo', null),
  ('71200000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', '71000000-0000-0000-0000-000000000003', 50, 'adjustment', 'Entrada demo', null),
  ('71200000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', '71000000-0000-0000-0000-000000000004', 25, 'adjustment', 'Entrada demo', null),
  ('71200000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001', '71000000-0000-0000-0000-000000000005', 10, 'adjustment', 'Entrada demo sin caducidad', null)
on conflict (id) do nothing;

insert into public.product_barcodes (id, org_id, supplier_item_id, barcode, symbology, created_by)
values
  ('81100000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000001', '1234567890123', 'ean_13', null),
  ('81100000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000002', '4000000000002', 'ean_13', null)
on conflict (org_id, barcode) do update
set supplier_item_id = excluded.supplier_item_id,
