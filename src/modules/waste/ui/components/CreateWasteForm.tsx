...
export function CreateWasteForm({ onSuccess, onCancel }: Props) {
    ...
    const { data: hotels } = useHotels(activeOrgId ?? undefined)
    const { mutateAsync: createEntry, isPending } = useCreateWasteEntry(activeOrgId ?? undefined)
