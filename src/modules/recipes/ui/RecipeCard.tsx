 ...
 * Memoized to prevent re-renders of all cards when the selected card changes.
 * Only the previously selected card and the newly selected card will re-render.
 */
