...
// Memoized component to prevent re-renders when parent state changes (e.g. selection)
const RecipeListItem = memo(function RecipeListItem({ recipe, isActive, onSelect }: RecipeListItemProps) {
  return (
    <Link
