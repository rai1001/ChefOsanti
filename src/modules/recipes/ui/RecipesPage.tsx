...
export default function RecipesPage() {
  ...
  // Stable handler to ensure RecipeCard memoization works correctly
        ...
        <Card className="rounded-3xl border border-border/25 bg-surface/70 p-5 space-y-4">
          ...
          >
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              {filtered.map((r) => (
                /* ⚡ Bolt Performance Optimization: RecipeCard is memoized to avoid full list re-renders on selection/scaling */
                <RecipeCard
                  key={r.id}
                  recipe={r}
